...
export class CanvasPO {
  ...
  async click(cell: Cell, opts?: { shiftKey?: boolean; metaKey?: boolean; altKey?: boolean }): Promise<void> {
    await this.grid.click(cell, opts)
  }

  async clickCenter(start: Cell, end: Cell, opts?: { shiftKey?: boolean; metaKey?: boolean; altKey?: boolean }): Promise<void> {
    await this.grid.clickCenter(start, end, opts)
  }

  async dblClick(cell: Cell, opts?: { shiftKey?: boolean; metaKey?: boolean; altKey?: boolean }): Promise<void> {
