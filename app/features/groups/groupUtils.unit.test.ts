...
describe("expandSelectionToGroups", () => {
  ...
  it("handles multiple groups", () => {
    ...
    const result = expandSelectionToGroups([el1, el2, el3, el4], new Set(["a", "c"]));
...
describe("reorderElementsForGroup", () => {
  it("moves group elements to be contiguous at topmost position", () => {
    ...
    const result = reorderElementsForGroup([el1, el2, el3, el4], new Set(["a", "c"]));
  ...
  it("preserves order when group is already contiguous", () => {
    ...
    const result = reorderElementsForGroup([el1, el2, el3], new Set(["a", "b"]));
  ...
  it("handles group at the end", () => {
    ...
    const result = reorderElementsForGroup([el1, el2, el3], new Set(["a", "c"]));
