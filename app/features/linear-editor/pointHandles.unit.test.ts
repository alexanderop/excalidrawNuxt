...
describe('getPointPositions', () => {
  ...
  it('handles multi-point arrows', () => {
    const el = createTestArrowElement({
      x: 5,
      y: 5,
      points: [pointFrom<LocalPoint>(0, 0), pointFrom<LocalPoint>(10, 0), pointFrom<LocalPoint>(10, 10)],
    })
...
describe('getMidpointPositions', () => {
  ...
  it('returns N-1 midpoints for N points', () => {
    const el = createTestArrowElement({
      x: 0,
      y: 0,
      points: [pointFrom<LocalPoint>(0, 0), pointFrom<LocalPoint>(40, 0), pointFrom<LocalPoint>(40, 40)],
    })
...
describe('insertPointAtSegment', () => {
  ...
  it('inserts at correct position in multi-segment arrow', () => {
    const points = [pointFrom<LocalPoint>(0, 0), pointFrom<LocalPoint>(40, 0), pointFrom<LocalPoint>(40, 40)]
...
describe('removePoints', () => {
  it('removes point by index', () => {
    const points = [pointFrom<LocalPoint>(0, 0), pointFrom<LocalPoint>(50, 0), pointFrom<LocalPoint>(100, 0)]
