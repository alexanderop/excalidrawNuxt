...
import type { ElementsMap } from '~/features/elements/types'
import {
  bindTextToContainer,
...
vi.mock('~/features/rendering/textMeasurement', () => ({
...
describe('deleteBoundTextForContainer', () => {
  it('marks bound text as deleted', () => {
    ...
    const elementMap = toElementsMap([[textEl.id, textEl], [container.id, container]])
