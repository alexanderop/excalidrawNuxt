...
import { hitTest, getElementAtPosition } from "../selection/hitTest";
import { getElementBounds, getCommonBounds } from "../selection/bounds";
import { createElement } from "../elements/createElement";
import { mutateElement } from "../elements/mutateElement";
import { generateShape, clearShapeCache } from "../rendering/shapeGenerator";
...
function getCreatedArrow(
  onElementCreated: ReturnType<typeof vi.fn>,
  callIndex = 0,
